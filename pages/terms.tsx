      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">3. Subscriptions & Payment</h2>
            ...
            <section>
              ...
              <p>Questions about these Terms? Contact us at <a href="mailto:info@aibiojobs.com" className="text-blue-400 hover:underline">info@aibiojobs.com</a>.</p>
            </section>
          </div>
