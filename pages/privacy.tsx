    ...
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 mb-8">Last updated: March 10, 2026</p>
          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p>We use essential cookies to operate the service. We may also use analytics tools (e.g., Simple Analytics) that respect privacy and do not collect personal data.</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-4">6. Your Rights</h2>
              <p>You may request access to, correction of, or deletion of your personal data. To make such requests, contact us at <a href="mailto:info@aibiojobs.com" className="text-blue-400 hover:underline">info@aibiojobs.com</a>.</p>
            </section>
            ...
            <section>
              ...
              <p>We may update this Privacy Policy from time to time. We will notify users of material changes by email or via the service. Continued use after changes constitutes acceptance.</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-4">9. Contact</h2>
              <p>For privacy-related questions, contact us at <a href="mailto:info@aibiojobs.com" className="text-blue-400 hover:underline">info@aibiojobs.com</a>.</p>
            </section>
          </div>
